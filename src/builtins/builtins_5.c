...
/*   Updated: 2026/07/21 00:47:43 by megrelli         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../../inc/minishell.h"

static char	*export_extract_key(char *arg, char *eq)
{
	if (eq)
...
static int	env_set_update(t_env *env, char *key, char *value)
{
	t_env	*e;
...
static void	env_set(t_env **env, char *key, char *value)
{
	t_env	*new;
