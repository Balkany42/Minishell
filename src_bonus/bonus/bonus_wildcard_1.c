...
/*   Updated: 2026/07/21 01:55:01 by megrelli         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../../inc/minishell_bonus.h"

static void	wild_add_back(t_wildlist **lst, char *name)
{
	t_wildlist	*new;
	t_wildlist	*tmp;
...
static void	wild_clear(t_wildlist **lst)
{
	t_wildlist	*cur;
	t_wildlist	*next;
...
static t_wildlist	*wild_read_directory(void)
{
	DIR				*dir;
	struct dirent	*entry;
	t_wildlist		*lst;
