...
/*   Updated: 2026/07/21 01:54:02 by megrelli         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../../inc/minishell_bonus.h"

static int	unset_is_invalid(char *key, t_minishell *sh)
{
...
static void	unset_remove_key(t_env **env, char *key)
{
	t_env	*cur;
	t_env	*prev;
...
static void	unset_process_one(char *key, t_minishell *sh)
{
