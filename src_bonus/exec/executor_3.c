...
/*   Updated: 2026/07/21 01:22:44 by megrelli         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../../inc/minishell_bonus.h"

static void	pipeline_child_empty(t_cmd *cmd)
{
	char	buffer[4096];
	ssize_t	n;
...
static void	pipeline_child_pipes(t_cmd *cmd, int prev_fd, int pipefd[2])
{
	if (prev_fd != -1)
	{
