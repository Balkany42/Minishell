...
/*   Updated: 2026/07/21 01:56:41 by megrelli         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../../inc/minishell_bonus.h"

static void	check_is_directory(char *path)
{
	struct stat	st;
...
static void	exec_with_path(t_cmd *cmd, t_minishell *sh)
{
...
static void	exec_from_envpath(t_cmd *cmd, t_minishell *sh)
{
	char	*cmdpath;
